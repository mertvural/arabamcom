...
import { TakeOptions, Sort, sortDirection, Take } from "../enums.ts/listingEnums";
...
<template>
  ...
  <div class="flex justify-between gap-5 mb-3">
    ...
    <div class="card flex justify-center">
        <Select v-model="selectedTake" :options="TakeOptions" optionLabel="name" optionValue="value" placeholder="İlan sayısını seçiniz" class="w-full md:w-56" />
    </div>
  </div>
